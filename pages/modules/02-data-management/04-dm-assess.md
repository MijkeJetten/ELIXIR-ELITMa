...
Before deciding what to develop further, it helps to understand where you are now.

An assessment can help you make existing work more visible. It can show that an area is already well developed, that practices differ across the Node or that something depends heavily on one person, project or institution.

It can also help you distinguish between different situations. Something may be:

* already working well
* available but not consistently used
* developing
* difficult to find or coordinate
* provided by another organisation
* outside the current scope of the Node

These differences matter. Not every area needs to reach the same level of maturity, and a lower maturity level does not automatically mean that something is wrong or missing.
...
Each domain contains more specific indicators. These cover areas such as RDM strategy, personnel, funding, training, communication, guidelines, services, infrastructure, standards and data management planning.
...
Choose one or two areas that you want to understand better.
...
3. **Compare perspectives**  
   Would people from different institutions or roles give the same answer?

4. **Record what is working**  
   Which parts are already clear, established or useful?

5. **Note what could improve**  
   Where is there inconsistency, limited visibility, unclear ownership or another issue worth exploring?
...
* Where did you find differences between institutions or perspectives?
* Which activities exist but are difficult to find or coordinate?
* Where is ownership or responsibility unclear?
* Which areas depend heavily on individual people or temporary arrangements?
* Did the assessment reveal something that you had previously considered a gap but is actually available elsewhere?
* Which possible improvements emerged from the discussion?
