...
The full International Model is detailed, but you do not need to use it all at once. Its essential elements provide a practical starting point for understanding how infrastructure, services, governance and people work together.

## Why is this relevant?

A research commons brings together the resources, services, people and agreements needed to support research. This may include research data, software, publications, technical infrastructure, tools, standards, governance, expertise and community support.

A research commons is therefore more than a collection of technical services. Its effectiveness also depends on the people, rules and organisational structures that allow resources and services to be developed, maintained and used.

The GORC framework was developed through the Research Data Alliance to provide a common language and structure for describing these different elements. It can support discussion of needs and priorities, coordination between infrastructures and communities and comparison between different research commons.
...
Use the visual to review your Node context.

Consider:

* which elements are already visible
* which activities relate to more than one element
...
* [GORC Typology and Definitions](https://www.rd-alliance.org/groups/global-open-research-commons-ig/outputs/)
* [GORC International Model, version 1.1](https://www.rd-alliance.org/groups/gorc-international-model-wg/outputs/the-global-open-research-commons-international-model-version-1-1/)
* [GORC International Model Report, version 1](https://www.rd-alliance.org/groups/gorc-international-model-wg/outputs/the-global-open-research-commons-international-model-report-version-1/)
* [The Global Open Research Commons International Model](https://datascience.codata.org/articles/10.5334/dsj-2024-056)
