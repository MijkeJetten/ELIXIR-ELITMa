...
page_id: # use things like mod_dm_2
type: # chose a type from data/module_types 
...
audience : # list the primary ones, not all use [] and separate types with a comma. These appear in the module tiles and metadata at the top
